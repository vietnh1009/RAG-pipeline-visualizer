...
def _render_vlm_panel(key_prefix: str) -> None:
    ...
    """
    st.session_state.setdefault(f'_vlm_describe_{key_prefix}', False)
    ...
    if vision_provider == "openai":
        ...
        st.session_state.setdefault(f'_vlm_url_{key_prefix}', 'http://localhost:11434/v1')
        st.text_input(
            "Ollama base URL",
...
def render_loader_settings() -> dict:
    ...
    if pdf_strategy == "marker":
        ...
        if odl_mode == "hybrid":
            ...
            with col_port:
                st.session_state.setdefault('odl_hybrid_port', 5002)
...
step=1,
            ...
            with col_ocr:
                st.session_state.setdefault('odl_force_ocr', False)
        ...
        # ── use_struct_tree ───────────────────────────────────────────────────
        st.session_state.setdefault('odl_struct_tree', False)
